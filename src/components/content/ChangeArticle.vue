...
export default {
  ...
  methods: {
    redata() {
      this.$http
        .post(
          `/api/articleController/getUpdateArticle/${this.$route.params.fid}`
        )
        .then(res => {
          this.main = res.data.article_Edit;
          this.plates = res.data.plate;
          this.editor.txt.html(res.data.article_Edit.fcontent);
    ...
    save() {
      ...
      formData.append("fid", this.main.fid);
      ...
      if (
        ...
        if (typeof imgFile != "undefined") {
          ...
          this.$http
            .post(`/api/articleController/updateArticle`, formData, {
              processData: false,
              contentType: false
            })
            .then(res => {
          ...
          this.$http
            .post(`/api/articleController/updateArticleNotPhoto`, formData, {
              processData: false,
              contentType: false
            })
            .then(res => {
